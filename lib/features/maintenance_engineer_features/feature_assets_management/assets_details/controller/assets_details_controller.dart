...
class AssetsDetailController extends GetxController {
  ...
  void onViewMore(String section) => {
        if (section == "Assets Specification")
          {Get.toNamed(Routes.maintenanceEngeneerassetsSpecificationScreen)}
        else if (section == "Assets Dashboard")
          {Get.toNamed(Routes.maintenanceEngeneerassetsDashboardScreen)}
        else if (section == "PM Schedule")
          {Get.toNamed(Routes.maintenanceEngeneerassetsPMSchedular)}
        else if (section == "Assets History")
          {Get.toNamed(Routes.maintenanceEngeneerassetsHistoryScreen)},
      };
  ...
  void viewChecklist() =>
      {Get.toNamed(Routes.maintenanceEngeneerpMCheckListScreen)};
}
