...
import 'package:easy_ops/features/maintenance_engineer_features/feature_maintenance_work_order/maintenance_wotk_order_management/models/work_order.dart';
...
class _GradientHeader
  ...
  Widget build(BuildContext context) {
    ...
    final double vPadTop =
        isTablet ? 8 : 8; // top content padding (below status bar)
    final double vPadBottom = isTablet ? 12 : 12;
    final double titleRowH =
        isTablet ? 40 : 36; // back button/tap target height
      ...
      child: InkWell(
        onTap: () => {
          if (order.status.name == 'resolved')
            {
              Get.toNamed(Routes.maintenanceEngeneerupdateWorkOrderTabScreen,
                  arguments: order)
            }
          else
            Get.toNamed(Routes.maintenanceEngeneerworkOrderDetailsTabScreen,
                arguments: order),
    ...
    return NavigationBarTheme(
      ...
      child: NavigationBar(
        ...
        onDestinationSelected: (i) {
          ...
          switch (i) {
            case 0:
              Get.toNamed(Routes.maintenanceEngeneerhomeDashboardScreen);
              break;
            case 1:
            ...
            case 2:
              Get.toNamed(
                  Routes.maintenanceEngeneerassetsManagementDashboardScreen);
              break;
            case 3:
              Get.toNamed(Routes.maintenanceEngeneerworkOrderDetailsTabScreen);
              break;
