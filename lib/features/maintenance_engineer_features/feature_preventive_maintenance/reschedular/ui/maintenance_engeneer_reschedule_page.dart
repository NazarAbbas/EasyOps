...
class MaintenanceEngineerReschedulePage
    extends GetView<MaintenanceEnginnerPurposedNewSlotController> {
  const MaintenanceEngineerReschedulePage({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: Obx(() {
        ...
        final opt1Complete = controller.opt1Date.value != null &&
            controller.opt1From.value != null &&
            controller.opt1To.value != null;

        final opt2Complete = controller.opt2Date.value != null &&
...
class _Pill extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final bg =
        color == _C.danger ? const Color(0xFFFFEAEA) : const Color(0xFFEFF4FF);
    return Container(
    ...
    return _SoftCard(
      child: Column(
        ...
        children: [
          ...
          Obx(() {
            final date =
                isFirst ? controller.opt1Date.value : controller.opt2Date.value;
            return _TappableBox(
