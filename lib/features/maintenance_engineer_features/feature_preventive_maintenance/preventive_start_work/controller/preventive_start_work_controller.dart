...
import 'package:easy_ops/features/maintenance_engineer_features/feature_preventive_maintenance/preventive_start_work/models/preventive_start_work.dart';
...
class PreventiveStartWorkController extends GetxController {
  ...
  void proposeNew() =>
      Get.toNamed(Routes.maintenanceEngeneerpurposedNewSlotScreen);
  void addMoreResources() =>
      Get.toNamed(Routes.maintenanceEngeneeraddResourceScreen);
