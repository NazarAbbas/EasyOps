                ...
                child: ListView.separated(
                  ...
                  itemBuilder: (_, i) {
                    ...
                    return _WorkOrderCard(
                      ...
                      onTap: () {
                        Get.toNamed(Routes
                            .maintenanceEngeneerpreventiveWorkOrderScreen);
    ...
    return NavigationBarTheme(
      ...
      child: NavigationBar(
        ...
        onDestinationSelected: (i) {
          ...
          switch (i) {
            case 0:
              Get.offAllNamed(Routes.maintenanceEngeneerhomeDashboardScreen);
              break;
            case 1:
              Get.toNamed(Routes.maintenanceEngeneersparePartsTabsShellScreen);
              break;
            case 2:
              Get.offAllNamed(
              ...
              break;
            case 3:
              Get.toNamed(Routes.maintenanceEngeneerpreventiveWorkOrderScreen);
              break;
          }
        },
      ),
