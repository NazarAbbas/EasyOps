...
class MaintenanceEngineerSuggestionDetailPage
    extends GetView<MaintenanceEnginnerSuggestionDetailController> {
  const MaintenanceEngineerSuggestionDetailPage({super.key});
