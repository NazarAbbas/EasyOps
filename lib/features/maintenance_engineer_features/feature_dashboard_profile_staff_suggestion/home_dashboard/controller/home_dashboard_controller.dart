...
class MaintenanceEnginnerHomeDashboardController extends GetxController {
  ...
  void onSummeryHeaderTap(String title) {
    if (title == 'Work Orders') {
      Get.toNamed(Routes.maintenanceEngeneergeneralWorkOrderScreen);
      // Get.offAllNamed(
      ...
      Get.toNamed(Routes.maintenanceEngeneerpreventiveDashboardScreen);
    } else if (title == 'My Team') {
      Get.toNamed(Routes.maintenanceEngeneerstaffScreen);
    } else if (title == 'Dashboard') {
      Get.toNamed(Routes.maintenanceEngeneermyDashboardScreen);
