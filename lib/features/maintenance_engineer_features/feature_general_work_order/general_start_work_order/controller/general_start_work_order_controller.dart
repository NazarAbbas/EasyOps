...
class MaintenanceEnginnerGeneralStartWorkOrderController
  ...
  Future<void> startOrder() async {
    ...
    Get.toNamed(Routes.maintenanceEngeneergeneralSubmitWorkOrderScreen);
  }

  void gotoReassignWorkOrder() async {
    Get.toNamed(Routes.maintenanceEngeneergeneralReOpensWorkOrderScreen);
  }
