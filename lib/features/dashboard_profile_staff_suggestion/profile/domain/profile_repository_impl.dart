...
import 'package:easy_ops/features/dashboard_profile_staff_suggestion/profile/domain/profile_repository.dart';
...
class ProfileRepositoryImpl implements ProfileRepository {
  ...
  Future<ApiResult<void>> logout() async {
    try {
      ...
      return ApiResult<void>(httpCode: code, message: msg);
    } catch (e) {
      return ApiResult<void>(httpCode: 0, message: e.toString());
    }
  }
}
