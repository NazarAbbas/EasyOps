...
import 'package:easy_ops/features/production_manager_features/dashboard_profile_staff_suggestion/assets_management/assets_management_dashboard/models/area_group.dart';
...
class _GroupSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      ...
      final filteredItems =
          group.items.where((it) => matchesTab(it, currentTab)).toList();
