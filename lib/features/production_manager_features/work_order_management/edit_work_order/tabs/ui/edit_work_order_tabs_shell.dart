...
import 'package:easy_ops/features/production_manager_features/work_order_management/edit_work_order/mc_history/ui/edit_mc_history_page.dart';
...
class EditWorkOrderTabsShell extends StatelessWidget {
  const EditWorkOrderTabsShell({super.key});
    ...
    return Scaffold(
      ...
      body: Obx(
        () => IndexedStack(
          ...
          children: [
            EditWorkOrderInfoPage(),
            const EditOperatorInfoPage(),
            const EditMcHistoryPage(),
          ],
        ),
      ),
    );
