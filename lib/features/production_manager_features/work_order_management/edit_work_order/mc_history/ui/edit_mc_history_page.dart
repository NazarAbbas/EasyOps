...
import 'package:easy_ops/features/production_manager_features/work_order_management/create_work_order/mc_history/models/history_items.dart';
import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

class EditMcHistoryPage extends GetView<McHistoryController> {
  const EditMcHistoryPage({super.key});
...
class _StatsCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Widget cell(String l, String v) => Column(
          ...
          children: [
            Text(l,
                style: label.copyWith(fontSize: (label.fontSize ?? 14) - 1)),
            const SizedBox(height: 2),
            Text(v,
                style: value.copyWith(fontSize: (value.fontSize ?? 14) - 1)),
          ],
        );
    ...
    Widget pipe() => const Padding(
          ...
          child: Text(
            '|',
            style: TextStyle(
                color: Color(0xFFE1E7F2), fontWeight: FontWeight.w800),
          ),
        );
